...
class _OrderTrackingScreenState extends State<OrderTrackingScreen> {
  ...
  Future<void> _fetchOrderStatus() async {
    ...
    try {
      ...
      if (mounted) setState(() => _errorMessage = 'Error al cargar el estado: ${e.toString()}');
    } finally {
      if (mounted) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              icon: const Icon(Icons.refresh), onPressed: _isLoading ? null : _fetchOrderStatus)
        ],
      ),
          ...
          ? Center(
              child: Padding(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  ElevatedButton(
                      onPressed: _fetchOrderStatus, child: const Text('Reintentar'))
                ]),
              ))
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  if (_isLoading) const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 3)),
                ],
              ),
            ),
  ...
  Widget _buildOrderTimeline(String status) {
    ...
    final statusOrder = ['confirmado', 'en preparacion', 'en camino', 'entregado'];
